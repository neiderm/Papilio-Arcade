...
# set PATHs
rom_path_src=../roms/sega_frogger
rom_path=../build
...
# REM concatenate consecutive ROM regions
cat $rom_path_src/epr-1012.ic5 $rom_path_src/epr-1013a.ic6 $rom_path_src/epr-1014.ic7 $rom_path_src/epr-1015.ic8 > $rom_path/rom.bin
